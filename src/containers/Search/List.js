...
export default class List extends PureComponent {
  ...
  GetData() {
    ...
    this.setState(
      ...
      () => {
        Axios.post('https://api.tomatohut.cn/api/Shop/searchList', {
          cid,
          sort,
          page: list_page,
          q: this.props.navigation.state.params.keyword,
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <TouchableOpacity
            activeOpacity={1}
            style={styles.header_body}
            onPress={() => Navigation.pop()}>
            <Image
              source={require('../../images/search_icon.png')}
              style={styles.header_body_icon}
            />
            <Text style={styles.header_body_input} numberOfLines={1}>
              {/*【{this.props.navigation.state.params.keyword}】的搜索结果*/}
